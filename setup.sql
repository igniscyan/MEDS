...
CREATE TABLE IF NOT EXISTS `patient_encounters` (
  ...
  `disbursement_9` int,
  `disbursement_10` int,
  `disbursement_1_quantity` int,
  `disbursement_2_quantity` int,
  `disbursement_3_quantity` int,
  `disbursement_4_quantity` int,
  `disbursement_5_quantity` int,
  `disbursement_6_quantity` int,
  `disbursement_7_quantity` int,
  `disbursement_8_quantity` int,
  `disbursement_9_quantity` int,
  `disbursement_10_quantity` int,
